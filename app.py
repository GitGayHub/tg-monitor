            ...
            for sid, stat in summary_stats.items():
                ...
                if is_pve_pos or is_edition:
                    ...
                    if best_with_pve:
                        ...
                        p_str = f"{int(p)}₽"
                        spaces_len = len(p_str) + 3 if len(p_str) <= 4 else len(p_str) + 2
                    ...
                    if best_with_pve:
                        ...
                        spaces_len = max_len + 3 if len(pve_str) <= 4 else max_len + 2
                        spaces_str = " " * spaces_len
                    ...
                    if best_without_pve:
                        ...
                        spaces_len = max_len + 3 if len(nopve_str) <= 4 else max_len + 2
                        spaces_str = " " * spaces_len
